...
var vec__8144 = axis;
var a_x = cljs.core.nth.call(null,vec__8144,(0),null);
var a_y = cljs.core.nth.call(null,vec__8144,(1),null);
var a_z = cljs.core.nth.call(null,vec__8144,(2),null);
var vec__8145 = v;
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__8146,p__8147){
var vec__8150 = p__8146;
var u1 = cljs.core.nth.call(null,vec__8150,(0),null);
var u2 = cljs.core.nth.call(null,vec__8150,(1),null);
var u3 = cljs.core.nth.call(null,vec__8150,(2),null);
var vec__8151 = p__8147;
var v1 = cljs.core.nth.call(null,vec__8151,(0),null);
var v2 = cljs.core.nth.call(null,vec__8151,(1),null);
var v3 = cljs.core.nth.call(null,vec__8151,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__8152_SHARP_){
return (p1__8152_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return (function (p1__8153_SHARP_){
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__8153_SHARP_,axis,angle);
});})(axis))
;
...
return (function (p1__8154_SHARP_){
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__8154_SHARP_,angle_lr),angle_ud);
...
var map__8161 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__8161__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__8161__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__8163 = cljs.core._EQ_;
var expr__8164 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__8163.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__8164))){
return straight;
} else {
if(cljs.core.truth_(pred__8163.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__8164))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__8163.call(null,quil.middlewares.navigation_3d.space,expr__8164))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__8163.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__8164))){
return up;
} else {
if(cljs.core.truth_(pred__8163.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__8164))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__8163.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__8164))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__8161,map__8161__$1,up,straight){
return (function (p1__8155_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__8155_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__8161,map__8161__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__8166_SHARP_);
});})(initial_state))
);
});
/**
...
var map__8172_8177 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__8172_8178__$1 = ((((!((map__8172_8177 == null)))?((((map__8172_8177.cljs$lang$protocol_mask$partition0$ & (64))) || (map__8172_8177.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8172_8177):map__8172_8177);
var vec__8173_8179 = cljs.core.get.call(null,map__8172_8178__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_8180 = cljs.core.nth.call(null,vec__8173_8179,(0),null);
var c_y_8181 = cljs.core.nth.call(null,vec__8173_8179,(1),null);
var c_z_8182 = cljs.core.nth.call(null,vec__8173_8179,(2),null);
var vec__8174_8183 = cljs.core.get.call(null,map__8172_8178__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_8184 = cljs.core.nth.call(null,vec__8174_8183,(0),null);
var u_y_8185 = cljs.core.nth.call(null,vec__8174_8183,(1),null);
var u_z_8186 = cljs.core.nth.call(null,vec__8174_8183,(2),null);
var vec__8175_8187 = cljs.core.get.call(null,map__8172_8178__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_8188 = cljs.core.nth.call(null,vec__8175_8187,(0),null);
var p_y_8189 = cljs.core.nth.call(null,vec__8175_8187,(1),null);
var p_z_8190 = cljs.core.nth.call(null,vec__8175_8187,(2),null);
quil.core.camera.call(null,p_x_8188,p_y_8189,p_z_8190,(p_x_8188 + c_x_8180),(p_y_8189 + c_y_8181),(p_z_8190 + c_z_8182),u_x_8184,u_y_8185,u_z_8186);
